...
public class DeathStatueInventory implements Inventory, Nameable {
    /**
    ...
    public final DeathStatueEntity player;
    private int changeCount;

    public DeathStatueInventory(DeathStatueEntity player) {
        this.player = player;
    }

    public ItemStack getMainHandStack() {
        if (net.minecraft.entity.player.PlayerInventory.isValidHotbarIndex(this.selectedSlot)) {
    ...
    public void addPickBlock(ItemStack stack) {
        ...
        if (net.minecraft.entity.player.PlayerInventory.isValidHotbarIndex(i)) {
            this.selectedSlot = i;
            return;
        }
        if (i == -1) {
